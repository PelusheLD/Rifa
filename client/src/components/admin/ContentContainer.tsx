...
export default function ContentContainer({ activeView }: ContentContainerProps) {
  ...
  const stats = {
    activeRaffles: rafflesData?.data?.filter((r: any) => r.status === 'activa')?.length || 0,
          ...
          <div className="animated fadeIn">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-3xl font-semibold text-gray-900">${stats.monthlyIncome}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-3xl font-semibold text-gray-900">{stats.deliveredPrizes}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="text-center py-12 text-gray-500">
                    <i className="fas fa-ticket-alt text-4xl mb-4 opacity-30"></i>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">Próximas Rifas</h3>
                    <button className="text-sm font-medium text-primary-600 hover:text-primary-800 transition-colors">
                      Ver todas
                    </button>
                  </div>
